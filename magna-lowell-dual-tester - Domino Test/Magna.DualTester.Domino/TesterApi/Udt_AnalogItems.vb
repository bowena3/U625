Namespace TesterApi
    ...
    'Public Class Model_AnalogItems
    '    Public VertAmp As New Model_AlgItem
    '    Public HorzAmp As New Model_AlgItem
    '    Public VertAngle As New Model_AlgItem
    '    Public HorzAngle As New Model_AlgItem
    '    Public Vert_Mem As New Model_AlgItem
    '    Public Horz_Mem As New Model_AlgItem
    '    Public DefogAmp As New Model_AlgItem
    '    Public Gi_Amp As New Model_AlgItem
    '    Public Bzi_Amp As New Model_AlgItem
    '    Public Ts_Amp As New Model_AlgItem
    '    Public Pf_Amp As New Model_AlgItem
    '    Public GlassPull As New Model_AlgItem
    '    Public Ec_Amp As New Model_AlgItem
    '    Public CargoLamp_Amp As New Model_AlgItem
    '    Public Oats_Amp As New Model_AlgItem
    '    Public Nest As Integer
    'End Class
End Namespace